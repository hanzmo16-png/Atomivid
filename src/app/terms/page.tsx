...
export default function TermsPage() {
  return (
    <LegalLayout
      ...
      updated="Beta"
      crossLink={{ href: "/privacy", label: "Privacidad" }}
      toc={[
        { id: "servicio", label: "Qué es el servicio" },
        { id: "responsabilidad-contenido", label: "Tu responsabilidad" },
        { id: "suscripcion", label: "Suscripción y pagos" },
        { id: "disponibilidad", label: "Disponibilidad" },
        { id: "limites", label: "Límites de responsabilidad" },
        { id: "avatar-consent", label: "Modo avatar" },
      ]}
    >
      <p>
      ...
      <h2 id="servicio">Qué es el servicio</h2>
      <p>
      ...
      <h2 id="responsabilidad-contenido">Tu responsabilidad sobre el contenido</h2>
      <p>
      ...
      <h2 id="suscripcion">Suscripción y pagos</h2>
      <p>
      ...
      <h2 id="disponibilidad">Disponibilidad durante la beta</h2>
      <p>
      ...
      <h2 id="limites">Límites de responsabilidad</h2>
      <p>
